  ...
  <Image src="/assets/images/interiore11.jpg" alt="background hero mobile" fill sizes="100vw"/>
        ...
        <div className="lg:block lg:w-full h-screen bg-[url('/assets/images/interiore14.jpg')] bg-cover lg:bg-cover lg:bg-no-repeat">
          <div className="relative top-[12vh]flex flex-col items-center justify-center lg:relative bg-black/20 lg:flex lg:flex-row lg:justify-evenly lg:items-stretch lg:gap-x-3 lg:top-[32vh] xl:top-[43vh] 2xl:[40vh]">
            {/*============================== LINKS =======================*/}
            <div className="px-5 leading-5 sm:px-5 flex flex-col justify-center lg:w-2/3 lg:py-20">
              <h1 className="mt-5 py-3 text-zenseWhite font-black leading-9 text-3xl uppercase sm:text-7xl sm-leading-3  lg:py-6 lg:relative lg:text-zenseWhite lg:text-[4.33rem] lg:leading-9 lg:font-black  lg:uppercase lg:text-left xl:text-[4.66rem] 2xl:text-[7.166rem]">
                design interiore
              </h1>
              <h1 className=" -mt-2 font-black lg:text-left leading-5 text-5xl text-lime-200 uppercase sm:text-8xl md:-mt-5 md:text-8xl lg:-mt-3 lg:text-[7.33rem] lg:font-black xl:text-[11.33rem] lg:leading-3 ">
                8zenSe.com
              </h1>
              <p className=" text-zenseWhite text-[1.666rem] leading-9 sm:text-4xl lg:text-4xl lg:font-black lg:text-left">
